    ...
    for input_lang in input_langs:
        for target_lang in target_langs:
            ...
            for shot in shots:
                ...
                command = f" papermill codes/translation_translit_all_tokens_final.ipynb out.ipynb -p input_lang {input_lang} -p target_lang {target_lang} -p shots {shot} -p custom_model {model}"
