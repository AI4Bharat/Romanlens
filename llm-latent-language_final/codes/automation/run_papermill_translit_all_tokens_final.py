...
# ["en","hi","ml","ta","te","gu"]
# "fr","de", "hi", "ml"
# ["ml_translit", "hi_translit", "ta_translit","te_translit","gu_translit","hi","ml","ta","te","gu","ka","am","zh"]
...
# "sarvamai/sarvam-2b-v0.5","google/gemma-2-9b-it""bigscience/bloom-7b1","google/gemma-2-9b",,"google/gemma-2-9b","meta-llama/Llama-2-13b-chat-hf","meta-llama/Llama-2-7b-hf",,"google/gemma-2-2b-it","google/gemma-2-2b",
"google/gemma-2-9b-it","google/gemma-2-9b","meta-llama/Llama-2-13b-chat-hf","meta-llama/Llama-2-7b-hf"
        ...
        for target_lang in target_langs:
            ...
            for shot in shots:
                for X in quant:
                    ...
                    command = f" papermill codes/translation_translit_all_tokens_final.ipynb out.ipynb -p input_lang {input_lang} -p target_lang {target_lang} -p shots {shot} -p X {X} -p custom_model {model}"
