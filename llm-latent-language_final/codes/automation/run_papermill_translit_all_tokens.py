        ...
        for target_lang in target_langs:
            ...
            for shot in shots:
                for X in quant:
                    ...
                    command = f" papermill codes/translation_translit_all_tokens.ipynb out.ipynb -p input_lang {input_lang} -p target_lang {target_lang} -p shots {shot} -p X {X} -p custom_model {model}"
