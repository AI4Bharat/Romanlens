...
def format1_messages(en_word):
    examples_prompt = " English: mars - Malayalam: chovva \n English: bottle - Malayalam: kuppi \n English: tongue - Malayalam: naavu \n English: silver - Malayalam: velli \n "

    
    new_prompt = f"\n English: {en_word} - Malayalam: "
    
    return [
    {"role": "user", "content":  examples_prompt +'Just translate the english word to malayalam word in latin script dont generate anythiing else' +new_prompt},
    ]
...
df1[["lang","word_original","word_translation"]].to_csv('./data/langs/ml_translit/clean.csv', index=False)
