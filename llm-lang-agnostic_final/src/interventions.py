...
def patchscope_lens(
    ...
    Returns:
        ...
        of the next token for each prompt at each layer. Tensor is on the CPU.
    """
    # print( f'target_patch_prompt: {target_patch_prompts}')
...
def patchscope_intervention(
    ...
    if target_patch_prompts is None:
        target_patch_prompts = repeat_prompt()
    # print(f'target_patch_prompts: {target_patch_prompts}')
    ...
    # print(f'source_prompts: {source_prompts}')
    # print(f'len(target_patch_prompts): {len(target_patch_prompts)}')
    # print(f'target_patch_prompts: {target_patch_prompts}')
    hiddens = collect_activations(nn_model, source_prompts,layers = source_layer, remote=remote)
    # Collect the patch activations for each prompt at each layer
    with nn_model.trace(
        target_patch_prompts.prompts,
        remote=remote,
    ...
    #     print(f'target_patch_prompts.index_to_patch: {target_patch_prompts.index_to_patch}')
    #     print(f'hiddens: {hiddens}')
    #     print(f'source_prompts: {source_prompts}')
    # print(f'probs value shape: {probs.value.shape}')
    # print(f'probs value: {probs.value}')
